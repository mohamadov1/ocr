...
import com.ucf.tessrect.types.MrzDate;
import com.ucf.tessrect.types.MrzFormat;
import com.ucf.tessrect.types.MrzSex;
...
public class MrzParser {
    ...
    public String[] parseName(MrzRange range) {
        try {
            ...
            return new String[]{surname, givenNames.replaceAll("LL","").replaceAll(" L","").replaceAll(", K","").replaceAll(", ","")};
        }catch (Exception e){
            return new String[]{"", ""};
        }
    }
    ...
    public void checkValidCharacters(MrzRange range) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (c != FILLER && (c < '0' || c > '9') && (c < 'A' || c > 'Z') && (c != 'e')) {
